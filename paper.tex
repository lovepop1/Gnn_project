...
\caption{Validation ROC-AUC trajectories across 300 training epochs for GIN, GAT, and GraphSAGE on OGBG-MOLHIV. GIN reaches its peak performance early in the training cycle, while GAT requires more extensive epochs to stabilize its attention mechanisms.}
...
\begin{itemize}
    ...
    \item \textbf{Choose GraphSAGE} for large-scale tasks with tight parameter or compute budgets; it delivers competitive performance (within 0.2 pp of GAT on Amazon, marginally outperforming GAT by 0.002 ROC on MOLHIV) at less than half the parameter count.
